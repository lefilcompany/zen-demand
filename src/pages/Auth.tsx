...
export default function Auth() {
  ...
  return <div className="flex flex-col lg:flex-row min-h-screen">
      ...
      <div className="lg:hidden relative h-48 sm:h-64 md:h-72 overflow-hidden" style={{
      ...
      <div className="hidden lg:flex lg:w-1/2 xl:w-3/5 relative overflow-hidden" style={{
      backgroundImage: `url(${authBackground})`,
      backgroundSize: "cover",
      backgroundPosition: "center"
    }}>
        ...
        <div className="w-full max-w-md">
          <div className="mb-6 sm:mb-8 text-center">
            <h1 className="text-2xl sm:text-3xl font-bold text-foreground mb-2 flex items-center justify-center gap-2">
              Bem-vindo ao <img alt="SoMA+" src="/lovable-uploads/9889f524-0819-424e-9185-2cc441526116.png" className="h-10 w-20 inline-block items-center justify-center " />
            </h1>
            ...
            <TabsContent value="login" className="mt-0">
              <form onSubmit={handleLogin} className="space-y-4 sm:space-y-5">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="login-password" type="password" placeholder="••••••••" className="h-11 sm:h-12" value={loginData.password} onChange={e => setLoginData({
                  ...loginData,
            ...
            <TabsContent value="signup" className="mt-0">
              <form onSubmit={handleSignup} className="space-y-3 sm:space-y-4">
                <div className="space-y-2">
                  ...
                  <Input id="signup-name" type="text" placeholder="Seu nome" className="h-10 sm:h-11" value={signupData.fullName} onChange={e => setSignupData({
                  ...signupData,
                ...
                <div className="space-y-2">
                  ...
                  <Input id="signup-email" type="email" placeholder="seu@email.com" className="h-10 sm:h-11" value={signupData.email} onChange={e => setSignupData({
                  ...signupData,
                  email: e.target.value
                })} required />
                </div>
                <div className="space-y-2">
                  ...
                  <Input id="signup-phone" type="tel" placeholder="(00) 00000-0000" className="h-10 sm:h-11" value={signupData.phone} onChange={e => setSignupData({
                  ...signupData,
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-2">
                    ...
                    <Input id="signup-state" type="text" placeholder="UF" className="h-10 sm:h-11" value={signupData.state} onChange={e => setSignupData({
                    ...signupData,
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="signup-city" type="text" placeholder="Sua cidade" className="h-10 sm:h-11" value={signupData.city} onChange={e => setSignupData({
                    ...signupData,
                    city: e.target.value
                  })} required />
                  </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input id="signup-password" type="password" placeholder="••••••••" className="h-10 sm:h-11" value={signupData.password} onChange={e => setSignupData({
                  ...signupData,
                  password: e.target.value
                })} required />
                </div>
