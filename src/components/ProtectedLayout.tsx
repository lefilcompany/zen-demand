...
export function ProtectedLayout() {
  ...
  return (
    <SidebarProvider defaultOpen={defaultSidebarOpen} key={isTablet ? 'tablet' : 'desktop'}>
      <div className="flex h-full w-full bg-[hsl(var(--board-background))] p-2 md:p-3 overflow-hidden">
        <AppSidebar />
        <main className="flex-1 flex flex-col bg-background rounded-xl shadow-2xl border border-border/40 overflow-hidden min-h-0">
