...
Deno.test("handler: allows the known test project even when ENVIRONMENT is missing", async () => {
  Deno.env.delete("ENVIRONMENT");
  Deno.env.delete("NODE_ENV");
  Deno.env.set("SUPABASE_URL", "https://dcojvsftpzwfhgvamdgm.supabase.co");
  Deno.env.set("SUPABASE_SERVICE_ROLE_KEY", "service-role-stub");
  Deno.env.set("E2E_SEED_SECRET", "seed-secret");
