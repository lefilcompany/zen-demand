...
-- 1. sync_admin_to_all_boards: add as moderator instead of admin
...
-- 2. add_member_to_default_board: admins go to ALL boards as moderator
...
-- 3. create_board_with_services: add team admins as moderator (not board admin)
...
BEGIN
  ...
  -- Add ALL team admins as moderator (not board admin)
  INSERT INTO public.board_members (board_id, user_id, role, added_by)
