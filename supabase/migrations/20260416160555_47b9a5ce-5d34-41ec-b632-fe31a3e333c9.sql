...
-- 1. Revert sync_admin_to_all_boards: auto-add to ALL boards again
...
-- 2. Revert add_member_to_default_board: admins go to ALL boards
...
-- 3. Revert create_board_with_services: add all team admins to new boards
...
BEGIN
  ...
  -- Add ALL team admins to the new board
  INSERT INTO public.board_members (board_id, user_id, role, added_by)
  SELECT v_new_board.id, tm.user_id, 'admin'::team_role, v_user_id
