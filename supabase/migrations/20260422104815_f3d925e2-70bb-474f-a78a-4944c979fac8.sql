...
DROP POLICY IF EXISTS "Users allowed can add demand assignees" ON public.demand_assignees;
DROP POLICY IF EXISTS "Users allowed can remove demand assignees" ON public.demand_assignees;
